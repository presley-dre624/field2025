...
if(isset($_POST['submit_btn'])){
  ...
  $_SESSION['s-region'] = $_POST['region'];
  $_SESSION['s-district'] = $_POST['district'];
...
<body>
  ...
  <main id="main" class="main">
    ...
    <?php $course =  $fetch['course'];
      $_SESSION['s-course'] = $course;
     ?>
        ...
        <div class="update-profile">
              <form action="" method ="POST" enctype="multipart/form-data"> 
                <div class="flex" style="height: 42px;">
                    ...
                    <div class="inputBox">
                      <span><?php
                        $app = mysqli_query($conn, "SELECT COUNT(*) as app FROM application where student_id = '$user_id'") or die ('ERR CS00');
                        $res_app = mysqli_fetch_assoc($app);
                        $max_app = 3 - $res_app['app'];
                        echo 'You can make '.$max_app.' Applications';
                          ?>
                      </span>
                    </div>
                ...
                <input type="submit" name="submit_btn" value="Continue" class="btn">
