...
if (isset($_POST['changePass'])){
  ...
  $check_pass = mysqli_query($conn, "SELECT * FROM student where password = '$currPass' and id = '$user_id'") or die('ERR P00');

  if (mysqli_num_rows($check_pass) > 0){
      if($newPass == $retypePass){
          $update_pass = mysqli_query($conn, "UPDATE student SET password = '$newPass' where id = '$user_id'") or die('ERR P001');
          if ($update_pass){
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $fetch['first_name'].' '.$fetch['middle_name'].' '.$fetch['surname']; ?></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $fetch['gender']; ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Phone</div>
                    <div class="col-lg-9 col-md-8"><?php echo $fetch['phonenumber']; ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">University</div>
                    <div class="col-lg-9 col-md-8"><?php echo $fetch['University']; ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Reg NO</div>
                    <div class="col-lg-9 col-md-8"><?php echo $fetch['regno']; ?></div>
                  </div>
