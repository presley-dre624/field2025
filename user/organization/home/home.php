              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h3><?php echo $fetch['name'].'-'.$fetch['district']; ?></h3>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      <h6><?php
                      $std = mysqli_query($conn, "SELECT COUNT(*) as stdnts FROM accepted_application where organization_id = '$oid'") or die('ERR C00');
                        $no_of_students = mysqli_fetch_assoc($std);
                        echo $no_of_students['stdnts'];
