...
$select_student = mysqli_query($conn, "SELECT id, first_name, middle_name, surname, University, course, regno from student s
                                join application a on s.id = a.student_id
                                where a.organization_id = '$oid'") or die('failed to select student info');
?>
                        ...
                        <table class="rwd-table">
                            ...
                            <td data-th="Supplier Code">
                                ...
                                <td data-th="Net Amount">
                                  <a href="student_details.php" class="btnClick" style=" width: 120;
                                                                    border-radius: 5px;
                                                                    padding:10px 30px;
                                                                    color:#fff;
                                                                    display: block;
