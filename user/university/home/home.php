...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link collapsed" href="allocation.php">
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Number of Students with field allocation</h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      <h6><?php
                      $std = mysqli_query($conn, "SELECT COUNT(*) as stdnts FROM accepted_application") or die('ERR C00');
